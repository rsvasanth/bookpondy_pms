...
import { eventSchema } from "@/types/index";
import type { EventFormData, Variant, Event } from "@/types/index";
  ...
  useEffect(() => {
    if (data?.default) {
      ...
      reset({
        ...
        variant: (eventData.variant as any) || "primary",
  ...
  const getButtonVariant = (color: string) => {
    switch (color) {
      ...
      case "red":
        return "destructive";
      case "green":
        return "default"; // "success" is not a valid shadcn button variant in some versions
      case "yellow":
        return "outline"; // "warning" is not a valid shadcn button variant
      default:
        return "default";
    }
  };
                ...
                {colorOptions.map((color) => (
                  <DropdownMenuItem
                    ...
                    onClick={() => {
                      ...
                      setValue("variant", getEventStatus(color.key) as any);
                    }}
                  >
