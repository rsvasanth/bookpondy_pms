            ...
            <SidebarInset className="h-full flex flex-col overflow-hidden">
                ...
                <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4 bg-background">
                    ...
                    <div className="flex items-center gap-2 px-2 py-1">
                        <div className={`h-2 w-2 rounded-full ${navigator.onLine ? 'bg-emerald-500' : 'bg-amber-500'}`} />
                    ...
                    <div className="hidden md:flex items-center ml-2 px-3 py-1.5 rounded-md border bg-muted/50">
                    ...
                    <div className="ml-auto relative w-full max-w-sm mr-4 hidden sm:block">
                        ...
                        <input
                            placeholder="Search..."
                            className="w-full pl-9 h-9 border rounded-md bg-muted/50 text-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                        />
                    </div>
                    ...
                    <div className="hidden xl:flex items-center gap-2 mr-4">
                        ...
                        >
                            <UserPlus className="h-3.5 w-3.5 mr-1" /> Guest
                        </Button>
                        <Button
                            variant="outline"
                            size="sm"
                        ...
                        >
                            <Brush className="h-3.5 w-3.5 mr-1" /> Task
                        </Button>
                    </div>
